          ...
          <div class="cover">
            ...
            <div class="details">
              ...
              <div class="mini-languages">
                ${languages.map((language) => `<img src="${language}.png" alt="${language}">`)}
              </div>
            </div>
          </div>
...
const renderSkillsSection = () => {
    ...
    const skills = [
        { name: 'HTML', src: 'log-html' },
        { name: 'CSS', src: 'log-css' },
        { name: 'JavaScript', src: 'log-javascript' },
        { name: 'TypeScript', src: 'log-typescript' },
        { name: 'Node.js', src: 'log-node-js' },
        { name: 'Python', src: 'log-python' },
        { name: 'React.js', src: 'log-react' },
        { name: 'Git', src: 'log-git' },
        { name: 'Github', src: 'log-github' },
    ]

    cardsContainer.innerHTML = skills.map(({ name, src }, index) => `
    <div class="box" key="${index}">
      <p>${name}</p>
      <img src="${src}.png" alt="html">
    </div>
  `).join('')
}
